        ...
        <div className={`grid gap-6 grid-cols-1 ${tasks.length >= 7 ? 'md:grid-cols-2 xl:grid-cols-3' : 'md:grid-cols-2'}`}>
          ...
          <div className="h-full w-full flex justify-center items-center">
            <Button
              ...
              className="aspect-square w-full md:w-auto md:h-full bg-blue-500 hover:bg-blue-600 transition-colors text-white text-lg font-semibold flex md:flex-col items-center justify-center gap-2 rounded-lg md:rounded-full p-4 md:p-0"
            >
