  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          'bg-zinc-100 text-primary-foreground hover:bg-zinc-100/70 hover:text-primary-foreground focus:bg-zinc-100 focus:text-primary-foreground',
      ...
      components={{
        Dropdown: ({ value, onChange, children, ...props }: DropdownProps & { children?: React.ReactNode }) => {
          ...
          return (
            ...
            >
              <SelectTrigger className="pr-1.5 focus:ring-0 bg-white">
